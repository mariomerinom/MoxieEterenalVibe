//! Scroll (zkEVM) block fetcher.
//! 3s blocks, early MEV landscape, lower competition.
...
impl ScrollFetcher {
    pub fn new(rpc_http: String, rpc_ws: Option<String>, rate_limit_rps: u32) -> Self {
        Self {
            inner: EvmFetcher::new(Chain::Scroll, rpc_http, rpc_ws, rate_limit_rps, 10),
        }
    }
}

#[async_trait]
impl ChainFetcher for ScrollFetcher {
    fn chain(&self) -> Chain {
        Chain::Scroll
    }
